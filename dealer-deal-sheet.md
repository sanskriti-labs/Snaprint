...
Snaprint S1 is a self-service print kiosk that sits inside an existing xerox shop.
Students scan a QR on the screen with their phone → upload a file (PDF, Word, image) →
...
## THE COMMERCIAL DEAL (as agreed so far)

### Per-unit price to dealer
| Item | Amount |
|---|---|
| Snaprint S1 kiosk hardware | ₹40,000 (manufacturing cost) |
| Lifetime Snaprint OS software | ₹1,00,000 |
| Dealer margin buffer | ₹10,000 |
| **Total per unit** | **₹1,50,000** |
...
### Who earns what (per unit sold)

| Party | Earnings | Source |
|---|---|---|
| Dealer | 15–20% margin on combined package | Difference between dealer cost and what shop owner pays |
| Epson | 5% commission per kiosk sold | Paid by Snaprint (₹7,500 per unit) |
| Snaprint | Remaining after hardware + software cost + Epson commission | Dealer payment |
| Xerox shop owner | 90% of per-print revenue; platform fee to Snaprint | Their own customers |

> ⚠️ **OPEN QUESTION:** Does the 5% Epson commission come out of the dealer's margin, or is it Snaprint's cost on top of the ₹1,50,000? This needs to be clarified before dealers see numbers.
...
### Core offer
- Exclusive authorised Snaprint partner status for their territory (city or pincode)
- Kiosk + lifetime software at ₹1,50,000 per unit
- Epson handles installation at xerox shop locations (Epson earns 5% commission for this)
...
## WHAT THE XEROX SHOP OWNER EARNS (the story the dealer tells)

This is what the dealer uses to sell to the xerox shop owner.
Present it as a simple calculator:

| Daily prints | Monthly revenue | Platform fee (~10%) | Shop owner earns |
|---|---|---|---|
| 100 (low footfall) | ₹3,000 | ₹300 | **₹2,700** |
| 300 (medium footfall) | ₹9,000 | ₹900 | **₹8,100** |
| 500 (high footfall) | ₹15,000 | ₹1,500 | **₹13,500** |

**Break-even for shop owner:** at 300 prints/day, they recover their ~₹2,30,000 investment in under 6 months.
...
2. Dealer buys Epson printer → sells and delivers to xerox shop owner directly
3. Dealer orders Snaprint kiosk + software → pays 75% upfront to Snaprint
4. [WHO physically delivers the kiosk? Dealer collects from Snaprint?]
5. [WHO coordinates with Epson for installation?]
6. Epson installs kiosk at xerox shop
7. Dealer pays remaining 25% to Snaprint on delivery
8. Xerox shop owner is live
```
...
## OPEN QUESTIONS (must resolve before dealer meetings)
...
### Hardware & support
- [ ] Who handles hardware replacements if a unit is damaged?
      (Screen breaks, card reader fails, etc.)
- [ ] What is the cost structure for out-of-warranty hardware repairs?
- [ ] Who does the xerox shop owner call for a hardware problem?
...
- [ ] What payment terms does the dealer offer the xerox shop owner?
      Full payment upfront? EMI? Who bears the credit risk?
- [ ] Does the dealer need financing options to offer to shop owners?

---

## RECOMMENDED DEALER PITCH NAME

**"The Snaprint Authorised Epson Partner Programme"**

Territory: Exclusive. Support: Direct. Growth: Recurring.
...
**4. "Why should I sell Snaprint instead of just selling more printers?"**
→ One printer sale = one-time margin. One Snaprint sale = recurring relationship with that shop owner + recurring software revenue share + territory exclusivity.

**5. "What happens when Snaprint puts their price up after 2 years?"**
→ Have a clear answer on the software pricing roadmap. "Year 1-2: all updates free. Year 3+: new features at nominal cost, bug fixes always free." Make it specific.
